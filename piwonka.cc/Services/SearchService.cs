...
namespace Piwonka.CC.Services
{
    public class SearchService : ISearchService
    {
        ...
        public SearchService(ApplicationDbContext context, ILanguageService languageService)
        {
            _context = context;
        ...
        public async Task<SearchResultViewModel> SearchAsync(string query, Language? languageCode = null, int page = 1, int pageSize = 10)
        {
            ...
            var blogResults = await SearchBlogPostsAsync(searchTerms, languageCode.Value);
        ...
        private async Task<List<SearchResultItemViewModel>> SearchBlogPostsAsync(List<string> searchTerms, Language languageId)
        {
