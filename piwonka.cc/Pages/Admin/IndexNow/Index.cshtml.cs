...
namespace Piwonka.CC.Pages.Admin.IndexNow
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostNotifyUrlAsync(string url)
        {
            ...
            {
                TempData["ErrorMessage"] = "Bitte geben Sie eine g�ltige URL ein.";
                await LoadDataAsync();
                return Page();
            }
        ...
        public async Task<IActionResult> OnPostNotifyAllPagesAsync()
        {
            try
            {
                ...
                {
                    TempData["ErrorMessage"] = "Keine ver�ffentlichten Seiten gefunden.";
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> OnPostNotifyAllPostsAsync()
        {
            try
            {
                ...
                {
                    TempData["ErrorMessage"] = "Keine ver�ffentlichten Blog-Posts gefunden.";
                }
            }
            catch (Exception ex)
            {
        ...
        private async Task LoadDataAsync()
        {
            ...
            TotalUrls = PublishedPagesCount + PublishedPostsCount + 1; // +1 f�r Sitemap
        }
    }
}
